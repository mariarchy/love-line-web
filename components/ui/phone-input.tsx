    ...
    >
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="flex gap-1 rounded-e-none rounded-s-lg border-r-0 border-love-text/30 bg-love-bg px-3 focus:z-10 hover:bg-love-text/10"
          disabled={disabled}
        >
          <FlagComponent
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className="flex h-4 w-6 overflow-hidden rounded-sm bg-love-text/20 [&_svg:not([class*='size-'])]:size-full">
